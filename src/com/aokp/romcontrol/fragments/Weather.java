...
public class Weather extends AOKPPreferenceFragment implements
    ...
    public void onCreate(Bundle savedInstanceState) {
        ...
        mWeatherSyncInterval.setSummary(Integer.toString(WeatherPrefs.getRefreshInterval(mContext))
                + getString(R.string.weather_refresh_interval_minutes));
        ...
        switch (dialogId) {
            case LOC_WARNING:
                return new AlertDialog.Builder(getActivity())
                        .setTitle(getString(R.string.weather_loc_warning_title))
                        .setMessage(getString(R.string.weather_loc_warning_msg))
                        .setCancelable(false)
                        .setPositiveButton(getString(R.string.weather_loc_warning_positive),
                        ...
                        .setNegativeButton(getString(R.string.weather_loc_warning_negative), new DialogInterface.OnClickListener() {
                            public void onClick(DialogInterface dialog, int whichButton) {
                                dialog.dismiss();
                            }
                        }).create();
    ...
    public boolean onPreferenceChange(Preference preference, Object newValue) {
        if (preference == mWeatherSyncInterval) {
            ...
            preference.setSummary(newValue + getString(R.string.weather_refresh_interval_minutes));
