package com.baked.romcontrol.performance;
...
public class CPUSettings extends Fragment implements SeekBar.OnSeekBarChangeListener {
    ...
    public void onStopTrackingTouch(SeekBar seekBar) {
        ...
        for (int i = 0; i < mNumOfCpu; i++) {
            cpu1 = MAX_FREQ.replace("cpu0", "cpu" + i);
            cmd.su.runWaitFor("busybox echo " + mMaxFreqSetting + " > " + cpu1);
            cpu1 = MIN_FREQ.replace("cpu0", "cpu" + i);
            cmd.su.runWaitFor("busybox echo " + mMinFreqSetting + " > " + cpu1);
        }
    ...
    public class GovListener implements OnItemSelectedListener {
        public void onItemSelected(AdapterView<?> parent, View view, int pos, long id) {
            ...
            for (int i = 1; i < mNumOfCpu; i++) {
                cpu1 = GOVERNOR.replace("cpu0", "cpu" + i);
                cmd.su.runWaitFor("busybox echo " + selected + " > " + cpu1);
            }
