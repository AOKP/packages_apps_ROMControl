...
import com.aokp.romcontrol.github.tasks.DownloadImageTask;
...
public class CommitViewerDialog extends AlertDialog.Builder {
    ...
    private void setup() {
        ...
        String commitPath = "https://api.github.com/repos/"
            + Config.StaticVars.ORGANIZATION + mCommit.getPath()
            ...
            FindMissingCommitDataTask getMoreInfoTask = new FindMissingCommitDataTask() {
                ...
                protected void onPostExecute(GithubObject result) {
                    ...
                    if (result != null) {
                        ...
                        // handle author image
                        if (aImagUrl != null && aImagUrl.trim() != "") {
                            new DownloadImageTask(authorAvatar).execute(mCommit.getAuthorGravatar());
                        } else {
                        ...
                        if (cImagUrl != null && cImagUrl.trim() != "") {
