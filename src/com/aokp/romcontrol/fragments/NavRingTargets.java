...
public class NavRingTargets extends Fragment implements
    ...
    private TextView.OnClickListener mTargetNumListener = new TextView.OnClickListener() {
        public void onClick(View v) {
            createDialog(
                getResources().getString(R.string.title_navring_amount),
                getResources().getStringArray(R.array.pref_navring_amount_entries),
    ...
    private void setDrawables() {
        ...
        String temp = mBoolLongPress ? getResources().getString(R.string.text_true) : getResources().getString(R.string.text_false);
        ...
        if (uri.equals(CUSTOM_APP)) {
            ...
            switch (mTarget) {
                ...
                case 1:
                    ...
                    break;
                default:
                    int val = Integer.parseInt((String) uri);
