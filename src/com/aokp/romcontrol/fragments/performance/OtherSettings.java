...
public class OtherSettings extends AOKPPreferenceFragment implements OnSharedPreferenceChangeListener, OnPreferenceChangeListener {
    ...
    public void onCreate(Bundle savedInstanceState) {
        ...
        PreferenceScreen ps = (PreferenceScreen) findPreference("voltage_control");
        if (!new File(VoltageControlSettings.MV_TABLE0).exists()) {
            ((PreferenceCategory) getPreferenceScreen().findPreference("voltage_control"))
                    .removePreference(ps);
        }
