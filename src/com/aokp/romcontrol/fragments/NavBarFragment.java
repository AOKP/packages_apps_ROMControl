...
public class NavBarFragment extends AOKPPreferenceFragment implements
    ...
    public void onCreate(Bundle savedInstanceState) {
        ...
        menuDisplayLocation.setValue(Settings.AOKP.getInt(mContentRes,
                Settings.AOKP.MENU_LOCATION, 0) + "");

        mNavBarMenuDisplay = (ListPreference) findPreference(PREF_NAVBAR_MENU_DISPLAY);
        mNavBarMenuDisplay.setOnPreferenceChangeListener(this);
        mNavBarMenuDisplay.setValue(Settings.AOKP.getInt(mContentRes,
                Settings.AOKP.MENU_VISIBILITY, 0) + "");

        mNavBarHideEnable = (CheckBoxPreference) findPreference(NAVBAR_HIDE_ENABLE);
        mNavBarHideEnable.setChecked(Settings.AOKP.getBoolean(mContentRes,
                Settings.AOKP.NAV_HIDE_ENABLE, false));

        final int defaultDragOpacity = Settings.AOKP.getInt(mContentRes,
                Settings.AOKP.DRAG_HANDLE_OPACITY, 50);
        ...
        final int defaultDragWidth = Settings.AOKP.getInt(mContentRes,
                Settings.AOKP.DRAG_HANDLE_WEIGHT, 5);
        ...
        mNavBarHideTimeout.setValue(Settings.AOKP.getInt(mContentRes,
                Settings.AOKP.NAV_HIDE_TIMEOUT, 3000) + "");

        boolean hasNavBarByDefault = mContext.getResources().getBoolean(
                com.android.internal.R.bool.config_showNavigationBar);
        mEnableNavigationBar = (CheckBoxPreference) findPreference(ENABLE_NAVIGATION_BAR);
        mEnableNavigationBar.setChecked(Settings.AOKP.getBoolean(mContentRes,
                Settings.AOKP.NAVIGATION_BAR_SHOW, hasNavBarByDefault));
        ...
        final float defaultButtonAlpha = Settings.AOKP.getFloat(mContentRes,
                Settings.AOKP.NAVIGATION_BAR_BUTTON_ALPHA, 0.6f);
        ...
        float defaultPort = Settings.AOKP.getFloat(mContentRes,
                Settings.AOKP.NAVIGATION_BAR_WIDTH_PORT, 0f);
        ...
        float defaultLand = Settings.AOKP.getFloat(mContentRes,
                Settings.AOKP.NAVIGATION_BAR_WIDTH_LAND, 0f);
        ...
        mMenuArrowKeysCheckBox.setChecked(Settings.AOKP.getBoolean(mContentRes,
                Settings.AOKP.NAVIGATION_BAR_MENU_ARROW_KEYS, true));
    ...
    public View onCreateView(LayoutInflater inflater, ViewGroup container,
        ...
        View ll = inflater.inflate(R.layout.fragment_navbar, container, false);
    ...
    /* Removed for now - need to see how new layout effects menu system - Zaphod 12/29/13
    @Override
    ...
    public boolean onOptionsItemSelected(MenuItem item) {
        switch (item.getItemId()) {
            case R.id.reset:
                Settings.AOKP.putInt(mContentRes,
                        Settings.AOKP.NAVIGATION_BAR_COLOR, -1);
                Settings.AOKP.putInt(mContentRes,
                        Settings.AOKP.NAVIGATION_BAR_TINT, -1);
                Settings.AOKP.putInt(mContentRes,
                        Settings.AOKP.NAVIGATION_BAR_GLOW_TINT, -1);
                Settings.AOKP.putInt(mContentRes,
                        Settings.AOKP.NAVIGATION_BAR_BUTTONS_QTY, 3);

                Settings.AOKP.putString(mContentRes,
                        Settings.AOKP.NAVIGATION_CUSTOM_ACTIVITIES[0], "**back**");
                Settings.AOKP.putString(mContentRes,
                        Settings.AOKP.NAVIGATION_CUSTOM_ACTIVITIES[1], "**home**");
                Settings.AOKP.putString(mContentRes,
                        Settings.AOKP.NAVIGATION_CUSTOM_ACTIVITIES[2], "**recents**");

                Settings.AOKP.putString(mContentRes,
                        Settings.AOKP.NAVIGATION_LONGPRESS_ACTIVITIES[0], "**null**");
                Settings.AOKP.putString(mContentRes,
                        Settings.AOKP.NAVIGATION_LONGPRESS_ACTIVITIES[1], "**null**");
                Settings.AOKP.putString(mContentRes,
                        Settings.AOKP.NAVIGATION_LONGPRESS_ACTIVITIES[2], "**null**");

                Settings.AOKP.putString(mContentRes,
                        Settings.AOKP.NAVIGATION_CUSTOM_APP_ICONS[0], "");
                Settings.AOKP.putString(mContentRes,
                        Settings.AOKP.NAVIGATION_CUSTOM_APP_ICONS[1], "");
                Settings.AOKP.putString(mContentRes,
                        Settings.AOKP.NAVIGATION_CUSTOM_APP_ICONS[2], "");
                loadButtons();
                refreshSettings();
                return true;
            default:
...
*/
    ...
    public boolean onPreferenceTreeClick(PreferenceScreen preferenceScreen,
        ...
        if (preference == mEnableNavigationBar) {
            ...
            Settings.AOKP.putInt(mContentRes,
                    Settings.AOKP.NAVIGATION_BAR_SHOW,
                    ((CheckBoxPreference) preference).isChecked() ? 1 : 0);
            Helpers.restartSystemUI();
            return true;
        } else if (preference == mNavBarHideEnable) {
            Settings.AOKP.putBoolean(mContentRes,
                    Settings.AOKP.NAV_HIDE_ENABLE,
                    ((CheckBoxPreference) preference).isChecked());
            mDragHandleOpacity
                    .setInitValue(Settings.AOKP.getInt(getActivity().getContentResolver(),
                            Settings.AOKP.DRAG_HANDLE_OPACITY, 50));
            mDragHandleWidth.setInitValue(Settings.AOKP.getInt(getActivity().getContentResolver(),
                    Settings.AOKP.DRAG_HANDLE_WEIGHT, 5));
            mNavBarHideTimeout.setValue(Settings.AOKP.getInt(getActivity().getContentResolver(),
                    Settings.AOKP.NAV_HIDE_TIMEOUT, 3000) + "");
            refreshSettings();
            return true;
            ...
            Settings.AOKP.putBoolean(mContentRes,
                    Settings.AOKP.NAVIGATION_BAR_MENU_ARROW_KEYS,
                    ((CheckBoxPreference) preference).isChecked());
            return true;
        }
    ...
    public boolean onPreferenceChange(Preference preference, Object newValue) {
        ...
        if (preference == menuDisplayLocation) {
            ...
            Settings.AOKP.putInt(mContentRes,
                    Settings.AOKP.MENU_LOCATION, val);
            refreshSettings();
            ...
            Settings.AOKP.putInt(mContentRes,
                    Settings.AOKP.MENU_VISIBILITY, Integer.parseInt((String) newValue));
            return true;
        } else if (preference == mNavigationBarWidth) {
            String newVal = (String) newValue;
            int dp = Integer.parseInt(newVal);
            int width = mapChosenDpToPixels(dp);
            Settings.AOKP.putInt(mContentRes, Settings.AOKP.NAVIGATION_BAR_WIDTH,
                    width);
            return true;
            ...
            Settings.AOKP.putInt(mContentRes, Settings.AOKP.NAVIGATION_BAR_HEIGHT,
                    height);
            return true;
        } else if (preference == mNavBarHideTimeout) {
            int val = Integer.parseInt((String) newValue);
            Settings.AOKP.putInt(mContentRes,
                    Settings.AOKP.NAV_HIDE_TIMEOUT, val);
            return true;
            ...
            int height = mapChosenDpToPixels(dp);
            Settings.AOKP.putInt(mContentRes,
                    Settings.AOKP.NAVIGATION_BAR_HEIGHT_LANDSCAPE,
                    height);
            return true;
            ...
            Settings.AOKP.putInt(mContentRes,
                    Settings.AOKP.NAVIGATION_BAR_COLOR, intHex);
            refreshSettings();
            return true;
            ...
            Settings.AOKP.putInt(mContentRes,
                    Settings.AOKP.NAVIGATION_BAR_TINT, intHex);
            refreshSettings();
            return true;
            ...
            int intHex = ColorPickerPreference.convertToColorInt(hex);
            Settings.AOKP.putInt(mContentRes,
                    Settings.AOKP.NAVIGATION_BAR_GLOW_TINT, intHex);
            refreshSettings();
            return true;
            ...
            Settings.AOKP.putInt(mContentRes,
                    Settings.AOKP.NAVIGATION_BAR_GLOW_DURATION[0], offTime);
            Settings.AOKP.putInt(mContentRes,
                    Settings.AOKP.NAVIGATION_BAR_GLOW_DURATION[1], onTime);
            updateGlowTimesSummary();
            return true;
        } else if (preference == mButtonAlpha) {
            float val = Float.parseFloat((String) newValue);
            Settings.AOKP.putFloat(mContentRes,
                    Settings.AOKP.NAVIGATION_BAR_BUTTON_ALPHA,
                    val * 0.01f);
            refreshSettings();
            return true;
            ...
            Settings.AOKP.putInt(mContentRes,
                    Settings.AOKP.DRAG_HANDLE_OPACITY, op);
            return true;
            ...
            //int height = mapChosenDpToPixels(dp);
            Settings.AOKP.putInt(mContentRes,
                    Settings.AOKP.DRAG_HANDLE_WEIGHT, dp);
            return true;
        } else if (preference == mWidthPort) {
            float val = Float.parseFloat((String) newValue);
            Settings.AOKP.putFloat(mContentRes,
                    Settings.AOKP.NAVIGATION_BAR_WIDTH_PORT,
                    val * 0.4f);
            return true;
        } else if (preference == mWidthLand) {
            float val = Float.parseFloat((String) newValue);
            Settings.AOKP.putFloat(mContentRes,
                    Settings.AOKP.NAVIGATION_BAR_WIDTH_LAND,
                    val * 0.4f);
            return true;
    ...
    private void updateGlowTimesSummary() {
        int resId;
        String combinedTime = Settings.AOKP.getString(mContentRes,
                Settings.AOKP.NAVIGATION_BAR_GLOW_DURATION[1]) + "|" +
                Settings.AOKP.getString(mContentRes,
                        Settings.AOKP.NAVIGATION_BAR_GLOW_DURATION[0]);
    ...
    private void loadButtons() {
        mNumberofButtons = Settings.AOKP.getInt(mContentRes,
                Settings.AOKP.NAVIGATION_BAR_BUTTONS_QTY, 3);
        mButtons.clear();
        for (int i = 0; i < mNumberofButtons; i++) {
            String click = Settings.AOKP.getString(mContentRes,
                    Settings.AOKP.NAVIGATION_CUSTOM_ACTIVITIES[i]);
            String longclick = Settings.AOKP.getString(mContentRes,
                    Settings.AOKP.NAVIGATION_LONGPRESS_ACTIVITIES[i]);
            String iconuri = Settings.AOKP.getString(mContentRes,
                    Settings.AOKP.NAVIGATION_CUSTOM_APP_ICONS[i]);
    ...
    public void refreshButtons() {
        ...
        int navBarColor = Settings.AOKP.getInt(mContentRes,
                Settings.AOKP.NAVIGATION_BAR_COLOR, -1);
        int navButtonColor = Settings.AOKP.getInt(mContentRes,
                Settings.AOKP.NAVIGATION_BAR_TINT, -1);
        float navButtonAlpha = Settings.AOKP.getFloat(mContentRes,
                Settings.AOKP.NAVIGATION_BAR_BUTTON_ALPHA, STOCK_ALPHA);
        int glowColor = Settings.AOKP.getInt(mContentRes,
                Settings.AOKP.NAVIGATION_BAR_GLOW_TINT, 0);
        float BarAlpha = 1.0f;
        // Remove pending transparency port
        /*String alphas[];
        String settingValue = Settings.AOKP.getString(mContentRes,
                Settings.AOKP.NAVIGATION_BAR_ALPHA_CONFIG);
        ...
        int menuloc = Settings.AOKP.getInt(mContentRes,
                Settings.AOKP.MENU_LOCATION, 0);
        switch (menuloc) {
            case SHOW_BOTH_MENU:
    ...
    private void saveButtons() {
        Settings.AOKP.putInt(mContentRes, Settings.AOKP.NAVIGATION_BAR_BUTTONS_QTY,
                mNumberofButtons);
        for (int i = 0; i < mNumberofButtons; i++) {
            NavBarButton button = mButtons.get(i);
            Settings.AOKP.putString(mContentRes, Settings.AOKP.NAVIGATION_CUSTOM_ACTIVITIES[i],
                    button.getClickAction());
            Settings.AOKP
                    .putString(mContentRes, Settings.AOKP.NAVIGATION_LONGPRESS_ACTIVITIES[i],
                            button.getLongAction());
            Settings.AOKP.putString(mContentRes, Settings.AOKP.NAVIGATION_CUSTOM_APP_ICONS[i],
                    button.getIconURI());
        }
    }
