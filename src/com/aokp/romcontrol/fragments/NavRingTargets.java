...
public class NavRingTargets extends Fragment implements
    ...
    public void shortcutPicked(String uri, String friendlyName, Bitmap bmp, boolean isApplication) {
        if (!mLongTarget) {
            ...
            Toast.makeText(getActivity(), getProperSummary(uri) + R.string.action_long_save, Toast.LENGTH_LONG).show();
        }
        setDrawables();
    }
    ...
    public void onTrigger(View v, final int target) {
        ...
        if (!mLongPress) {
            ...
            final AlertDialog dialog = new AlertDialog.Builder(getActivity())
                    .setTitle(R.string.choose_action_short_title)
    ...
    final Runnable SetLongPress = new Runnable () {
        public void run() {
            if (!mSearchPanelLock) {
                ...
                final AlertDialog dialog = new AlertDialog.Builder(getActivity())
                    .setTitle(R.string.choose_action_long_title)
                    .setSingleChoiceItems(R.array.navring_dialog_entries, -1, l)
                    .create();
