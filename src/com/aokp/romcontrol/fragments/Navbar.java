...
public class Navbar extends AOKPPreferenceFragment implements
    ...
    public View onCreateView(LayoutInflater inflater,ViewGroup container, Bundle savedinstanceState){
       ...
       mButtonContainer = (LinearLayout) ll.findViewById(R.id.navbar_container);
       llbuttons = (LinearLayout) ll.findViewById(R.id.button_container);
       mButtonViews.clear();
    ...
    public void refreshButtons() {
        ...
        if (mBackground instanceof ColorDrawable) {
            ...
            bacd.setAlpha(a);
            llbuttons.setBackground(bacd);
        } else {
            mBackground.setAlpha(a);
            llbuttons.setBackground(mBackground);
        }
        for (int i = 0; i < mNumberofButtons; i++) {
            ...
            sld.addState(StateSet.WILD_CARD, llbuttons.getBackground());
