...
public class CreateShortcut extends LauncherActivity {
    ...
    protected Intent getTargetIntent() {
        ...
        targetIntent.addCategory("com.baked.romcontrol.SHORTCUT");
    ...
    protected void onListItemClick(ListView l, View v, int position, long id) {
        ...
        shortcutIntent.setAction("com.baked.romcontrol.START_NEW_FRAGMENT");
        shortcutIntent.putExtra("baked_fragment_name", intentClass);
