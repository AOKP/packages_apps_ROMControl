...
public class HeadphoneService extends Service {
    ...
    //bluetooth is a good option too!
    public static final String BT_AUDIO = "android.bluetooth.headset.profile.action.AUDIO_STATE_CHANGED";
    ...
    private BroadcastReceiver headsetReceiver = new BroadcastReceiver() {
        ...
        public void onReceive(Context context, Intent intent) {
            ...
            } else if (action.equals(BT_AUDIO)) {
                final int userPreferenceAudioMode = getUserBTAudioMode(context);
                
                if (userPreferenceAudioMode == MODE_UNTOUCHED)
                    return;

                final int state = intent.getIntExtra(BT_AUDIO, 12);
