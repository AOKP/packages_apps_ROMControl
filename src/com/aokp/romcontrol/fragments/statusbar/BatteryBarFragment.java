...
public class BatteryBarFragment extends Fragment {
    ...
    public View onCreateView(LayoutInflater inflater, ViewGroup container, Bundle savedInstanceState) {
        ...
        getChildFragmentManager().beginTransaction()
                .replace(R.id.batterybar_main, new BatteryBarPreferenceFragment())
                .commit();
    ...
    public void onCreate(Bundle icicle) {
        ...
        addPreferencesFromResource(R.xml.fragment_batterybar_settings);
        ...
        mBatteryBarUseGradient = (SystemSettingSwitchPreference) findPreference(PREF_BATT_BAR_USE_GRADIENT_COLOR);
        ...
        mBatteryBarChargingAnimation = (SystemSettingSwitchPreference) findPreference(PREF_BATT_ANIMATE);
