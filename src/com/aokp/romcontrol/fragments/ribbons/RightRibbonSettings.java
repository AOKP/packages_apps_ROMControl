...
public class RightRibbonSettings extends Fragment implements OnSeekBarChangeListener, OnColorChangedListener {
    ...
    private String[] SETTINGS_AOKP = Settings.AOKP.AOKP_RIGHT_RIBBON;
    ...
    public View onCreateView(LayoutInflater inflater, ViewGroup container, Bundle savedinstanceState) {
        ...
        mAnimationType.setValues(mAnimationsNum);
        ...
        mHandleColor.setOnClickListener(new Button.OnClickListener() {
            ...
            public void onClick(View v) {
                ...
                picker.setOnColorChangedListener(RightRibbonSettings.this);
                picker.show();
            }
        });
