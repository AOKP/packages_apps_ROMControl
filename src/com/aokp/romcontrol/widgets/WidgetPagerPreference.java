...
public class WidgetPagerPreference extends Preference {
    ...
    public void inflateWidgetPref() {
        ...
        ImageView widgetpreview = mAdapter.getView();
        if (widgetpreview != null) {
            widgetpreview.setOnClickListener(mDoPrefClick);
            
        }
        Log.d(TAG,"ImageView:" + widgetpreview);
     }
     ...
     private void updateSummary() {
         ...
         int widgetselected = mCurrentPage;
         setTitle(mAdapter.getLabel(mCurrentPage -1)); // adjust for array bounds
