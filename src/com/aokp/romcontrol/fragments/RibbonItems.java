...
public class RibbonItems extends Fragment implements ShortcutPickerHelper.OnPickListener,
    ...
    public RibbonItems(Context context, String ribbon) {
        mContext = context;
        mRibbon = ribbon;
        ...
        SETTINGS_AOKP = ribbon.equals("left") ? Settings.AOKP.AOKP_LEFT_RIBBON
                : Settings.AOKP.AOKP_RIGHT_RIBBON;
    }
    ...
    public View onCreateView(LayoutInflater inflater, ViewGroup container, Bundle savedInstanceState) {
        ...
        TextView instructions = new TextView(mContext);
        instructions.setText(R.string.toggles_ribbon_instructions);
