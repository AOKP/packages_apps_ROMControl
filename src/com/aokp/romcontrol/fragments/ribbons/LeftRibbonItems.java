...
public class LeftRibbonItems extends Fragment implements ShortcutPickerHelper.OnPickListener,
        OnItemClickListener {

    private static final String TAG = LeftRibbonItems.class.getSimpleName();
    ...
    public LeftRibbonItems() {
    }
    
    public LeftRibbonItems(Context context, String ribbon) {
...
/*            if (!TextUtils.isEmpty(uri)) {
    ...
    private class ConfigurationDragSortController extends DragSortController {
        ...
        public ConfigurationDragSortController() {
            super(LeftRibbonItems.this.mListView, R.id.drag_handle,
        ...
        public View onCreateFloatView(int position) {
            View v = mAdapter.getView(position, null, LeftRibbonItems.this.mListView);
            return v;
        }
