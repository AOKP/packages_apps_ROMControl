...
import com.baked.romcontrol.fragments.TabletPowerWidgetUtil;
import com.baked.romcontrol.widgets.TouchInterceptor;

public class TabletPowerWidget extends BAKEDPreferenceFragment
    ...
    public void onCreate(Bundle savedInstanceState) {
        ...
        if (getPreferenceManager() != null) {
            addPreferencesFromResource(R.xml.prefs_tablet_powerwidget);
