...
public class NavBarButtonsPref extends Preference implements ShortcutPickerHelper.OnPickListener {
    ...
    private View.OnTouchListener mGlowListener = new View.OnTouchListener() {
        ...
        public boolean onTouch(View v, MotionEvent event) {
            ...
            if (event.getAction() == MotionEvent.ACTION_DOWN) {
                ...
                v.setBackgroundColor(Color.parseColor("#00000000")); // action up - set background to blank
            }
            return false;
        }
    };
    ...
    public void refreshButtons(){
        int navBarColor = Settings.System.getInt(mContext.getContentResolver(),
                Settings.System.NAVIGATION_BAR_COLOR,-1);
        int navButtonColor = Settings.System.getInt(mContext.getContentResolver(),
        ...
        if (navBarColor != -1){
            Log.d(TAG,"NavBarColor" + navBarColor);
            mButtonContainer.setBackgroundColor(navBarColor);
        }
