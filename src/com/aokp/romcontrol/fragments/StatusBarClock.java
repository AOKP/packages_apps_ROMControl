...
public class StatusBarClock extends AOKPPreferenceFragment implements
    ...
    public void onCreate(Bundle savedInstanceState) {
        ...
        if (Integer.parseInt(mClockStyle.getValue()) == 0) {
            ...
            mClockShortClick.setEnabled(false);
            mClockLongClick.setEnabled(false);
            mClockDoubleClick.setEnabled(false);
        }
    }
    ...
    public boolean onPreferenceChange(Preference preference, Object newValue) {
        ...
        if (preference == mClockAmPmstyle) {
            ...
            if (val == 0) {
                ...
                mClockShortClick.setEnabled(true);
                mClockLongClick.setEnabled(true);
                mClockDoubleClick.setEnabled(true);
           }
