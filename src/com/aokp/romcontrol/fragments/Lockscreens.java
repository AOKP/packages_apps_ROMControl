...
public class Lockscreens extends AOKPPreferenceFragment implements
    ...
    public void onActivityCreated(Bundle savedInstanceState) {
        ...
        final String[] entries = getResources().getStringArray(R.array.pref_lockscreen_glowtorch_entries);
        ...
        mGlowTorchSwitch.post(new Runnable() {
            public void run() {
                mGlowTorchSwitch.setOnItemSelectedListener(new AmountListener());
            }
        });
    ...
    public class AmountListener implements OnItemSelectedListener {
        public void onItemSelected(AdapterView<?> parent, View view, int pos, long id) {
            final String[] values = getResources().getStringArray(R.array.pref_lockscreen_glowtorch_values);
    ...
    private void setDrawables() {
        ...
        mGlowTorchSwitch.setSelection(mGlowTorch - 1);
    ...
    public void updateDrawables() {
        ...
        mGlowTorch = (Settings.System.getInt(cr,
                Settings.System.LOCKSCREEN_TARGETS_LONGPRESS, 0));
