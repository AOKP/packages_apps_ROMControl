...
public class FloatingWindowsSettings extends Fragment {

    public FloatingWindowsSettings() {
    ...
    public View onCreateView(LayoutInflater inflater, ViewGroup container, Bundle savedInstanceState) {
        ...
        getChildFragmentManager().beginTransaction()
                .replace(R.id.floating_windows_main, new FloatingWindowsSettingsPreferenceFragment())
                .commit();
        return v;
    }
    ...
    public static class FloatingWindowsSettingsPreferenceFragment extends PreferenceFragment
           implements Preference.OnPreferenceChangeListener {

        public FloatingWindowsSettingsPreferenceFragment() {

        }

        private static final String TAG = "FloatingWindowsSettings";
