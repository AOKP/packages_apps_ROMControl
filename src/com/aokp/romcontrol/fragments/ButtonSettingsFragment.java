...
public class ButtonSettingsFragment extends Fragment {
    ...
    public static class SettingsPreferenceFragment extends PreferenceFragment implements
        ...
        private static final String KEY_SLIDER_SETTINGS = "notification_slider_settings";
        ...
        public static final String SLIDER_SETTINGS_PACKAGE_NAME = "com.cyanogenmod.settings.device.SliderSettings";
        ...
        private Preference mSliderSettings;
        ...
        public void onCreate(Bundle savedInstanceState) {
            ...
            mSliderSettings = (Preference)
                    prefSet.findPreference(KEY_SLIDER_SETTINGS);
            if (!Helpers.isPackageInstalled(SLIDER_SETTINGS_PACKAGE_NAME, pm)) {
                prefSet.removePreference(mSliderSettings);
            }
