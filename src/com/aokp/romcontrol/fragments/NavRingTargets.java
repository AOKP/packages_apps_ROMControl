...
public class NavRingTargets extends Fragment implements
    ...
    public void onValueChange(String uri) {
        if (uri.equals(CUSTOM_APP)) {
            ...
            mString = Settings.System.SYSTEMUI_NAVRING_ICON[mTargetIndex];
    ...
    public void onTrigger(View v, final int target) {
        ...
        if (mBoolLongPress) {
            createDialog(
                ...
                getResources().getStringArray(R.array.navring_long_dialog_entries),
                getResources().getStringArray(R.array.navring_long_dialog_values));
        } else {
            createDialog(
                getResources().getString(R.string.choose_action_title),
                getResources().getStringArray(R.array.navring_short_dialog_entries),
