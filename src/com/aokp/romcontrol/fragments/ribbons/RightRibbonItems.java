...
public class RightRibbonItems extends Fragment implements ShortcutPickerHelper.OnPickListener,
        OnItemClickListener {

    private static final String TAG = RightRibbonItems.class.getSimpleName();
    public static final int REQUEST_PICK_CUSTOM_ICON = 200;
    public static final int REQUEST_PICK_LANDSCAPE_ICON = 201;

    private Context mContext;
    private String mRibbon;
    String[] SETTINGS_AOKP = Settings.AOKP.AOKP_RIGHT_RIBBON;
    ...
    public RightRibbonItems() {
    }
    
    public RightRibbonItems(Context context, String ribbon) {
...
/*            if (!TextUtils.isEmpty(uri)) {
                image.setBackground(RibbonAdapter.getCustomDrawable(mContext, uri));
            }*/
    ...
    private class ConfigurationDragSortController extends DragSortController {
        ...
        public ConfigurationDragSortController() {
            super(RightRibbonItems.this.mListView, R.id.drag_handle,
        ...
        public View onCreateFloatView(int position) {
            View v = mAdapter.getView(position, null, RightRibbonItems.this.mListView);
            return v;
        }
    ...
    private void saveRibbons(ArrayList<RibbonItem> ribbonItems) {
        ...
        Settings.AOKP.putArrayList(mContext.getContentResolver(),
                SETTINGS_AOKP[AokpRibbonHelper.RIBBON_ITEMS], saveList);
        updateRibbonList();
        mAdapter.notifyDataSetChanged();
    }
    ...
    private ArrayList<RibbonItem> getRibbons() {
        ...
        ArrayList<String> joinedList = Settings.AOKP.getArrayList(mContext.getContentResolver(),
                SETTINGS_AOKP[AokpRibbonHelper.RIBBON_ITEMS]);
