...
public class LeftRibbonSettings extends Fragment implements OnSeekBarChangeListener, OnColorChangedListener {
    ...
    private String[] SETTINGS_AOKP = Settings.AOKP.AOKP_LEFT_RIBBON;
    ...
    public View onCreateView(LayoutInflater inflater, ViewGroup container, Bundle savedinstanceState) {
        ...
        mHandleColor.setOnClickListener(new Button.OnClickListener() {
            ...
            public void onClick(View v) {
                ...
                picker.setOnColorChangedListener(LeftRibbonSettings.this);
                picker.show();
            }
        });
