...
public class PieColorFragment extends Fragment {

    public PieColorFragment() {

    }

    @Override
    public View onCreateView(LayoutInflater inflater, ViewGroup container, Bundle savedInstanceState) {
        View v = inflater.inflate(R.layout.fragment_pie_color_main, container, false);
        ...
        getActivity().getFragmentManager().beginTransaction()
                .replace(R.id.pie_color_main, new PieColorPreferenceFragment())
                .commit();

        return v;
    }

    public static class PieColorPreferenceFragment extends PreferenceFragment
            implements OnPreferenceChangeListener {

        public PieColorPreferenceFragment() {
        ...
        public void refreshSettings() {
            ...
            addPreferencesFromResource(R.xml.fragment_pa_pie_color);
        ...
        public static class MyAlertDialogFragment extends DialogFragment {
            ...
            PieColorFragment.PieColorPreferenceFragment getOwner() {
                return (PieColorFragment.PieColorPreferenceFragment) getTargetFragment();
            }
            ...
            public Dialog onCreateDialog(Bundle savedInstanceState) {
                ...
                switch (id) {
                    case DLG_RESET:
                        ...
                        .setPositiveButton(R.string.reset_aokp,
                            new DialogInterface.OnClickListener() {
                            public void onClick(DialogInterface dialog, int which) {
                                Settings.System.putInt(getOwner().mResolver,
                                        Settings.System.PA_PIE_ENABLE_COLOR, 1);
