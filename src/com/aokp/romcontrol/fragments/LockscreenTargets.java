...
public class LockscreenTargets extends Fragment implements
        ShortcutPickerHelper.OnPickListener, ColorPickerDialog.OnColorChangedListener, GlowPadView.OnTriggerListener {
    ...
    public void onActivityCreated(Bundle savedInstanceState) {
        ...
        mTargetSpaceTop = ((View) getActivity().findViewById(R.id.target_space_top));
        ...
        mLockTextColorButton.setOnClickListener(new Button.OnClickListener() {
            ...
            public void onClick(View v) {
                ...
                picker.setOnColorChangedListener(LockscreenTargets.this);
                picker.show();
            }
        });
        ...
        mLockVolControlText = ((TextView) getActivity().findViewById(R.id.lockscreen_vol_controls_id));
        mLockVolControlText.setOnClickListener(mLockVolControlTextListener);
        mLockVolControlSwitch = (Switch) getActivity().findViewById(R.id.lockscreen_vol_controls_switch);
        mLockVolControlSwitch.setOnCheckedChangeListener(new CompoundButton.OnCheckedChangeListener() {
            @Override
            public void onCheckedChanged(CompoundButton v, boolean checked) {
                Settings.System.putBoolean(cr, Settings.System.VOLUME_MUSIC_CONTROLS, checked);
                updateSwitches();
            }
        });
        ...
        mLockAllWidgetsText = ((TextView) getActivity().findViewById(R.id.lockscreen_all_widgets_id));
        mLockAllWidgetsText.setOnClickListener(mLockAllWidgetsTextListener);
        mLockAllWidgetsSwitch = (Switch) getActivity().findViewById(R.id.lockscreen_all_widgets_switch);
        mLockAllWidgetsSwitch.setOnCheckedChangeListener(new CompoundButton.OnCheckedChangeListener() {
            @Override
            public void onCheckedChanged(CompoundButton v, boolean checked) {
                Settings.System.putBoolean(cr, Settings.System.LOCKSCREEN_ALL_WIDGETS, checked);
                updateSwitches();
            }
        });

        mLockUnlimitedWidgetsText = ((TextView) getActivity().findViewById(R.id.lockscreen_unlimited_widgets_id));
        mLockUnlimitedWidgetsText.setOnClickListener(mLockUnlimitedWidgetsTextListener);
        mLockUnlimitedWidgetsSwitch = (Switch) getActivity().findViewById(R.id.lockscreen_unlimited_widgets_switch);
        mLockUnlimitedWidgetsSwitch.setOnCheckedChangeListener(new CompoundButton.OnCheckedChangeListener() {
            @Override
            public void onCheckedChanged(CompoundButton v, boolean checked) {
                Settings.System.putBoolean(cr, Settings.System.LOCKSCREEN_UNLIMITED_WIDGETS, checked);
                updateSwitches();
            }
        });

        mLockPageHintText = ((TextView) getActivity().findViewById(R.id.lockscreen_hide_page_hints_id));
        mLockPageHintText.setOnClickListener(mLockPageHintTextListener);
        mLockPageHintSwitch = (Switch) getActivity().findViewById(R.id.lockscreen_hide_page_hints_switch);
        mLockPageHintSwitch.setOnCheckedChangeListener(new CompoundButton.OnCheckedChangeListener() {
            @Override
            public void onCheckedChanged(CompoundButton v, boolean checked) {
                Settings.System.putBoolean(cr, Settings.System.LOCKSCREEN_HIDE_INITIAL_PAGE_HINTS, checked);
                updateSwitches();
            }
        });

        mLockMinimizeChallangeText = ((TextView) getActivity().findViewById(R.id.lockscreen_minimize_challange_id));
        mLockMinimizeChallangeText.setOnClickListener(mLockMinimizeChallangeTextListener);
        mLockMinimizeChallangeSwitch = (Switch) getActivity().findViewById(R.id.lockscreen_minimize_challange_switch);
        mLockMinimizeChallangeSwitch.setOnCheckedChangeListener(new CompoundButton.OnCheckedChangeListener() {
            @Override
            public void onCheckedChanged(CompoundButton v, boolean checked) {
                Settings.System.putBoolean(cr, Settings.System.LOCKSCREEN_MINIMIZE_LOCKSCREEN_CHALLENGE, checked);
                updateSwitches();
            }
        });
        ...
        mLockCarouselSwitch.setOnCheckedChangeListener(new CompoundButton.OnCheckedChangeListener() {
            @Override
            public void onCheckedChanged(CompoundButton v, boolean checked) {
                Settings.System.putBoolean(cr, Settings.System.LOCKSCREEN_USE_WIDGET_CONTAINER_CAROUSEL, checked);
                updateSwitches();
            }
        });

        mLongPressText = ((TextView) getActivity().findViewById(R.id.lockscreen_target_longpress_id));
    ...
    private TextView.OnClickListener mLockCarouselTextListener = new TextView.OnClickListener() {
        public void onClick(View v) {
            createMessage(
                getResources().getString(R.string.lockscreen_use_widget_container_carousel_title),
                getResources().getString(R.string.lockscreen_use_widget_container_carousel_summary));
        }
    };

    private void updateSwitches() {
        mLockBatterySwitch.setChecked(Settings.System.getBoolean(cr, Settings.System.LOCKSCREEN_BATTERY, false));
        mLockRotateSwitch.setChecked(Settings.System.getBoolean(cr, Settings.System.LOCKSCREEN_AUTO_ROTATE, false));
        mLockVolControlSwitch.setChecked(Settings.System.getBoolean(cr, Settings.System.VOLUME_MUSIC_CONTROLS, false));
        mLockVolWakeSwitch.setChecked(Settings.System.getBoolean(cr, Settings.System.VOLUME_WAKE_SCREEN, false));
        mLockAllWidgetsSwitch.setChecked(Settings.System.getBoolean(cr, Settings.System.LOCKSCREEN_ALL_WIDGETS, false));
        mLockUnlimitedWidgetsSwitch.setChecked(Settings.System.getBoolean(cr, Settings.System.LOCKSCREEN_UNLIMITED_WIDGETS, false));
        mLockPageHintSwitch.setChecked(Settings.System.getBoolean(cr, Settings.System.LOCKSCREEN_HIDE_INITIAL_PAGE_HINTS, false));
        mLockMinimizeChallangeSwitch.setChecked(Settings.System.getBoolean(cr, Settings.System.LOCKSCREEN_MINIMIZE_LOCKSCREEN_CHALLENGE, false));
        mLockCarouselSwitch.setChecked(Settings.System.getBoolean(cr, Settings.System.LOCKSCREEN_USE_WIDGET_CONTAINER_CAROUSEL, false));
    ...
    private void updateVisiblity(boolean visible) {
        if (visible) {
            ...
            mGlowPadView.setLayoutParams(new LinearLayout.LayoutParams(LayoutParams.MATCH_PARENT, LayoutParams.WRAP_CONTENT, 0.6f));
            mTargetSpaceTop.setLayoutParams(new LinearLayout.LayoutParams(LayoutParams.MATCH_PARENT, 0, 0.4f));
            ...
            mGlowPadView.setLayoutParams(new LinearLayout.LayoutParams(LayoutParams.MATCH_PARENT, 0, 0.7f));
            mTargetSpaceTop.setLayoutParams(new LinearLayout.LayoutParams(LayoutParams.MATCH_PARENT, 0, 0.3f));
