...
public class IncreasingRingPreference extends VolumePreference implements
    ...
    protected void onBindDialogView(View view) {
        ...
        mEnabledCheckbox.setChecked(Settings.AOKP.getInt(cr, Settings.AOKP.INCREASING_RING, 0) == 1);
        mMinVolumeSeekBar.setProgress(Settings.AOKP.getInt(
                    cr, Settings.AOKP.INCREASING_RING_MIN_VOLUME, 1));
        int interval = Settings.AOKP.getInt(cr, Settings.AOKP.INCREASING_RING_INTERVAL, 0);
        int index = 0;
    ...
    protected void onDialogClosed(boolean positiveResult) {
        ...
        if (positiveResult) {
            ...
            Settings.AOKP.putInt(cr, Settings.AOKP.INCREASING_RING, checked ? 1 : 0);
            Settings.AOKP.putInt(cr, Settings.AOKP.INCREASING_RING_INTERVAL,
                    mIntervalValues[mInterval.getSelectedItemPosition()]);
            Settings.AOKP.putInt(cr,
                    Settings.AOKP.INCREASING_RING_MIN_VOLUME,
